...
- [ ] **Severity is carried, not acted on**
...
- [ ] **Arbitrary detail travels with the event**
...
- [ ] **Resource and step are bound for plugin authors**
...
- [ ] **Works across the plugin boundary**
...
- [ ] **Plugins load once per registry**
  A registry shared by several configurations loads each plugin only once.
- [ ] **Events go to the configuration that produced them**
...
- [ ] **Immediate checks where possible**
...
- [ ] **Receiver cannot affect processing**
...
- [ ] **Receiver panics are not absorbed**
...
- [ ] **Receiver panics shut down gracefully**
